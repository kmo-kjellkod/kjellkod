...
public class Bluetooth {
    ...
    public boolean send(String msg){
        try {
            ...
            Log.e("doff-bt", npe.getMessage());
            return false;
        } catch (IOException ioe) {
            Log.e("doff-bt", ioe.getMessage());
            connected=false;
            if(communicationCallback!=null)
                communicationCallback.onDisconnect(device, ioe.getMessage());
            return false;
        } catch (Exception e) {
            Log.e("doff-bt", e.getMessage());
            return false;
    ...
    private class ConnectThread extends Thread {
        public ConnectThread(BluetoothDevice device) {
            ...
            try {
                ...
                Log.d("doff-bt","ConnectThread: "+ Bluetooth.this.socket.toString());
            } catch (IOException e) {
                Log.e("doff-bt","ConnectThread: "+ e.getMessage());
                if(communicationCallback!=null)
                    communicationCallback.onError(e.getMessage());
            }
        }
